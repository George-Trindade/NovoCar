...
public class TelaUsuario extends javax.swing.JInternalFrame {
   ...
   ResultSet rs=null; 
    ...
    private void adicionar(){
     String sql="insert into tbusuarios(iduser,usuario,fone,login,senha,perfil) values(?,?,?,?,?,?)";   
            ...
            if(txtUsuId.getText().isEmpty()||txtUsuNome.getText().isEmpty()||
               ...
               cboUsuPerfil.getSelectedItem().equals("")){
               JOptionPane.showMessageDialog(null, "Todos os campos devem estar preenchidos, exceto o Fone!");
    ...
    private void deletar(){
     int confirma=JOptionPane.showConfirmDialog(null, "Remover Usuário?","Atenção",JOptionPane.OK_CANCEL_OPTION);
     if(confirma==JOptionPane.OK_OPTION){
        ...
        try{
           ...
           else{JOptionPane.showMessageDialog(null, "Não foi possível apagar o usuário.");}
    ...
    private void initComponents() {
        ...
        btnUsuUpdate.setToolTipText("Atualizar dados do Usuário");
        ...
        btnUsuDelete.setToolTipText("Apagar os dados do Usuário");
